                ...
                $this
                    .on("init.picker", function () {
                        ...
                        $pickerInput
                            ...
                            .autocomplete(itemsWithAliases, { instructions: opt.instructions })
                            ...
                            .on('instructionsShown', function (e, element) {
                                $this.triggerHandler("autocomplete.instructionsShown", [element]);
                            });
                    ...
                    .on('logToAnalytics', function (e, action, label, value) {
                        if (typeof googleAnalytics !== 'undefined') {
                            wng.googleAnalytics.trackEvent('Item Picker', action, { 'label': label, 'value': value, 'brand': wng.currentBrandName });
                        }
                    })
