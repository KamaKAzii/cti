          ...
          ", {
              ...
              year: year
                ...
                simplifyOrCorrectDate: function (date) {
                    ...
                    var twoDaysAfterLaterTimezone = date.getTimezoneOffset() > twoDaysAfter.getTimezoneOffset();
                      ...
                      if (!opt.preventManualEntry) {
                          if ($.trim(self.val()).length > 0) {
                              ...
                              if (selectedDate) {
                                  ...
                                  self.triggerHandler('displayDateError', opt.generalDateErrorMessage(opt.fieldName, self.val()), [self.val()]);
                              }
                          } else {
                              self.triggerHandler('displayDateError', opt.noDateEnteredErrorMessage(opt.fieldName));
                          }
                      }
                  })
